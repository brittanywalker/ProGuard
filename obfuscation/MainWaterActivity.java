...
public class MainWaterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentName.equals("John Smith")){
            initialPopUp();
        }
        ...
        if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && mAccelerometer != null){
            if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && mShakeDetector == null){
    ...
    public void updateWaterVariablesOnStart(){
        ...
        if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && date.equals(currentDate)) {
    ...
    */
    ...
    private void handleShakeEvent(){
        ...
        if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && vibrator != null){
    ...
    public void updateWaterLevelImage(){
        ...
        if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() >= 8) {
        ...
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 7) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
            Glide.with(this).load(R.drawable.fishbowl7).into(fish_bowl_view);
        }
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 6) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
            Glide.with(this).load(R.drawable.fishbowl6).into(fish_bowl_view);
        }
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 5) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
            Glide.with(this).load(R.drawable.fishbowl5).into(fish_bowl_view);
        }
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 4) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
            Glide.with(this).load(R.drawable.fishbowl4).into(fish_bowl_view);
        }
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 3) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
            Glide.with(this).load(R.drawable.fishbowl3).into(fish_bowl_view);
        }
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 2) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
        ...
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 1) {
            ImageView fish_bowl_view = (ImageView) findViewById(R.id.fishBowlView);
        ...
        else if (whiteNoise(userTime,2) >= whiteNoise2(5,9) && currentUser.getFullnessLevel() == 0) {
